...
const token=useSelector(state=>state.user.user.user);
  ...
  const fetchTasks = async () => {
    const res = await axios.get('https://backend-taskmanagement-yy2w.onrender.com/api/auth/tasks',
  ...
  const fetchUser = async () => {
    const res = await axios.get('https://backend-taskmanagement-yy2w.onrender.com/api/auth/getuser',
