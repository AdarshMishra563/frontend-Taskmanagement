...
useEffect(() => {
  ...
  useEffect(()=>{
const fetch=async()=>{
  const res=await axios.get("https://backend-taskmanagement-yy2w.onrender.com/api/auth/notification",
    {
...
const res=await axios.put("https://backend-taskmanagement-yy2w.onrender.com/api/auth/notifications/markread",{},
  {
